...
void HardwareRenderer::rasterize_line(float x0, float y0, float x1, float y1,
                                      Color color) {
...
void HardwareRenderer::rasterize_triangle(float x0, float y0, float x1,
...
void HardwareRenderer::rasterize_image(float x0, float y0, float x1, float y1,
                                       Texture &tex) {
  glColor4f(1, 1, 1, 1);
